    ...
    var taskConfig = {
        ...
        copy: {
            ...
            compile_assets: {
                files: [
                    {
                        src: [ '**' ],
                        dest: '<%= compile_dir %>/assets-login',
                        cwd: '<%= build_dir %>/assets-login',
                        expand: true
                    }
                ]
            }
        ...
        concat: {
            ...
            compile_js: {
                ...
                dest: '<%= compile_dir %>/assets-login/<%= pkg.name %>.js'
            }
        },
        ...
        recess: {
            ...
            compile: {
                ...
                dest: '<%= build_dir %>/assets-login/<%= pkg.name %>.css',
                options: {
                    compile: true,
                    compress: true,
                    noUnderscores: false,
